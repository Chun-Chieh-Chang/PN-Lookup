...
export const SearchControls: React.FC<SearchControlsProps> = ({
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-3 sm:px-4 lg:px-6 py-2 w-full">
      <div className="bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/80 p-3 sm:p-3.5 shadow-2xs">
        {/* Main Search Row */}
        <form onSubmit={handleSubmit} className="flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 transition-all shadow-2xs font-sans font-medium"
              autoFocus
            />
            {keyword && (
              <button
